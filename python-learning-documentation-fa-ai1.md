...
<details open>
<summary><strong>نمایش فهرست</strong></summary>

- [بخش اول: مبانی زبان، عملگرها و رشته‌ها](#part-1)
...
- [بخش دوم: ساختارهای داده و کنترل جریان](#part-2)
  - [لیست‌ها (List)](#section-08)
  - [دیکشنری‌ها (Dictionary)](#section-09)
  - [حلقه‌ها (Loops)](#section-10)
  - [تابع `zip()`](#section-11)
- [بخش سوم: توابع، تکرار و ابزارهای پیشرفته](#part-3)
...
- [بخش چهارم: متدهای انواع داده](#part-4)
...
- [بخش پنجم: کار با فایل‌ها و داده‌های ساخت‌یافته](#part-5)
...
- [بخش ششم: برنامه‌نویسی شیءگرا](#part-6)
...
- [بخش هفتم: مدیریت خطا، هشدار و اعتبارسنجی](#part-7)
